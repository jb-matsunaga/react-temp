...
/***/ function(module, exports, __webpack_require__) {
	...
	var _FormValidation = __webpack_require__(162);

	var _FormValidation2 = _interopRequireDefault(_FormValidation);

	var _Form1App = __webpack_require__(163);

	var _Form1App2 = _interopRequireDefault(_Form1App);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	_reactDom2.default.render(_react2.default.createElement(_FormValidation2.default, null), document.getElementById('fn-selectBox'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FormValidation = function (_React$Component) {
	    _inherits(FormValidation, _React$Component);

	    function FormValidation(props) {
	        _classCallCheck(this, FormValidation);

	        var _this = _possibleConstructorReturn(this, (FormValidation.__proto__ || Object.getPrototypeOf(FormValidation)).call(this, props));
	    ...
	    _createClass(FormValidation, [{
	        ...
	        value: function handleChange(array) {
	            ...
	            console.log(array);
	            var newArray = this.state.data.push(this.state.data, array);
	        ...
	        value: function render() {
	            ...
	            console.log(this.state.data);
	            var inputs = this.state.data.map(function (data) {
	                return _react2.default.createElement(Input, { key: data.id, data: data, _handleChange: _this2.handleChange.bind(_this2) });
	            });
	            return _react2.default.createElement(
	                'ul',
	                null,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Form1App = function (_React$Component) {
	    _inherits(Form1App, _React$Component);

	    function Form1App(props) {
	        _classCallCheck(this, Form1App);

	        var _this = _possibleConstructorReturn(this, (Form1App.__proto__ || Object.getPrototypeOf(Form1App)).call(this, props));
